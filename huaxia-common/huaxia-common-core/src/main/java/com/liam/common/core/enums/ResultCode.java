...
public enum ResultCode {
    ...
    FAILED_PASSWORD_ERROR(3111, "密码错误"),

    FAILED_PARAMETER_VALIDATION(3112, "参数校验失败"),
    ...
    GLOSSARY_TERM_NOT_EXISTS(3204, "为术语库新增的术语不存在"),
    ...
    GLOSSARY_IS_PUBLISHED(3208, "竞赛已经发布不能进行编辑、删除操作"),
